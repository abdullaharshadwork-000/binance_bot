...
async def _dashboard_payload(symbol: str | None = None) -> dict:
    ...
    return {
        ...
        "config": {
            ...
            "strategy_min_trend_atr": selected_settings.strategy_min_trend_atr,
            "max_consecutive_losses": selected_settings.max_consecutive_losses,
            "loss_streak_pause_seconds": selected_settings.loss_streak_pause_seconds,
